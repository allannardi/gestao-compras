...
Esta v0.5.1 está preparada para uso online com Turso. Localmente, se o Turso estiver configurado no secrets.toml, o app também usa Turso.
Para uso online permanente, o próximo passo recomendado é migrar o banco para **Turso**.


## v0.5.1 — Preparação Turso
...
## v0.5.1 — Caminho rápido para usar no iPhone
...
## v0.5.1 — Correção Streamlit Cloud
